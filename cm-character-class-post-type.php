...
if (class_exists('CmCharacterClassPostType')) { return; }

class CmCharacterClassPostType {

	// Type Identifier
	const TYPE_NAME                 = 'cm-character-class';

	// Type Labels & Description
	const LABEL_NAME                = 'Character Class';
	const LABEL_SINGULAR_ITEM       = 'Character Class';
	const LABEL_ADD_NEW_ITEM        = 'Add New Character Class';
	const LABEL_EDIT_ITEM           = 'Edit Character Class';
	const LABEL_NEW_ITEM            = 'New Character Class';
	const LABEL_VIEW_ITEM           = 'View Character Class';
	const LABEL_VIEW_ITEMS          = 'View Character Class';
	const LABEL_SEARCH_ITEMS        = 'Search Character Class';
	const LABEL_NOT_FOUND           = 'No Character Class';
	const LABEL_NOT_FOUND_IN_TRASH  = 'No Character Class Found in Trash';
	const LABEL_ALL_ITEMS           = 'All Character Class';
	const LABEL_ARCHIVE             = 'Character Class Archives';
	const LABEL_ATTRIBUTES          = 'Character Class Attributes';
	const LABEL_INSERT_INTO_ITEM    = 'Insert into Character Class';
	const LABEL_FILTER_ITEMS        = 'Filter Character Class list';
	const LABEL_ITEM_NAVIGATION     = 'Character Class list navigation';
	const LABEL_ITEMS_LIST          = 'Character Class list';
	const LABEL_ITEM_PUBLISHED      = 'Character Class published';
	const LABEL_ITEM_PUBLISHED_PRIVATE  = 'Character Class published privately';
	const LABEL_ITEM_REVERTED_TO_DRAFT  = 'Character Class reverted to draft';
	const LABEL_ITEM_SCHEDULED          = 'Character Class scheduled';
	const LABEL_ITEM_UPDATED            = 'Character Class updated';
	const TYPE_DESCRIPTION              = 'A d20 character class';
	...
	//const TYPE_MENU_ICON                = 'none'; // default - may also use base64 encoded image OR icon character class name
	const TYPE_MENU_ICON                = 'dashicons-lightbulb';
